...
const Transactions = () => {
  ...
  const recentTransactions = useMemo(() => {
    ...
    return transactions.filter(t => new Date(t.createdAt || t.date) >= oneYearAgo);
  }, [transactions]);
  ...
  const filteredTransactions = useMemo(() => {
    ...
    return filtered
  }, [recentTransactions, searchTerm, filterStatus, filterType, sortBy, sortOrder])
            ...
            <div className="bg-white rounded-3xl shadow-sm overflow-hidden mb-6">
              ...
              {filteredTransactions.length === 0 && recentTransactions.length === 0 && transactions.length > 0 && (
                <div className="text-center py-16">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">No recent transactions to show</h3>
                  <p className="text-gray-600">Transactions older than one year are hidden. Any new transactions will appear here.</p>
                </div>
              )}
