        ...
        <div className="min-h-screen bg-gray-50 pb-20 p-4 md:p-10 rounded-t-3xl">
            ...
            {user?.isAdmin && (
                <div className="mb-6">
                    <Link
                        to="/admin"
                        className="flex items-center justify-between p-4 bg-gradient-to-r from-amber-500 to-orange-500 rounded-2xl shadow-lg hover:from-amber-400 hover:to-orange-400 transition-all group"
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-white text-sm">Admin Control Center</p>
                                <p className="text-amber-100 text-xs">Create transactions, manage users &amp; more</p>
                            </div>
                        </div>
                        <FiChevronRight className="w-5 h-5 text-white group-hover:translate-x-1 transition-transform" />
                    </Link>
                </div>
            )}
            {/* Top Header */}
